# Decypher
***
![running_game](images\Screenshot 2026-05-13 094401.png)
...
## How to use
***
1. Only library needed to be installed to run is pygame.
2. Go to the main file in src, and run it with python.
3. You can then either choose to run the demo or make a save. 
4. The demo will just put you straight into a run and not save anything.
5. Making a save will start you in the home base, and allow you to access meta progression.
